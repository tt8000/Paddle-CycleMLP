...
class SoftTargetCrossEntropy(paddle.nn.Layer):
...
class DistillationLoss(paddle.nn.Layer):
    ...
    """
    def __init__(self, base_criterion: paddle.nn.Layer, teacher_model: paddle.nn.Layer,
